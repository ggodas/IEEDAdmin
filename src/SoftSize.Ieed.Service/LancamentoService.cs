...
namespace SoftSize.Ieed.Service
{
    ...
    {
        private IRepository<LancamentoBase, Guid> lancamentosBase;
        private IRepository<LancamentoDespesa, Guid> lancamentoDespesas;
        private IMovimentoDeCaixaService movimentoDeCaixaService;
        private IRepository<Associado, Guid> associados;

        public LancamentoService(
            IMovimentoDeCaixaService movimentoDeCaixaService,
            IRepository<Associado, Guid> associados,
            IRepository<LancamentoBase, Guid> lancamentosBase,
            IRepository<LancamentoDespesa, Guid> lancamentoDespesas)
        {
