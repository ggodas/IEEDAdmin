...
{
    public class SSOProfileProvider : ProfileProvider
    {
    ...
    public class SSORule : RoleProvider
    {
        [Inject]
        public IPermissaoServiceApplication PermissaoServiceApplication { get; set; }
        ...
        public override string[] GetRolesForUser(string username)
        {
            ...
            long entityId;
            string[] roles = null;
            return PermissaoServiceApplication.RecuperarPermissoesPor(username).Select(x => x.NomeDaFuncionalidade.ToString()).ToArray(); ;
    ...
    public class SSOMembershipProvider : MembershipProvider
    {
        ...
        {
            UsuarioServiceApplication.Incluir(
                new RegisterModel()
                {
        ...
        {
            var usuario = UsuarioServiceApplication.RecuperarPor(username, password);
            return usuario != null;
        }
